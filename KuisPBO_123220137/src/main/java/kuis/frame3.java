...
public class frame3 extends JFrame implements ActionListener {
        JLabel header = new JLabel("Input Penyewaan Motor");
...
//    JLabel  = new JLabel("");
    ...
    JRadioButton r1 = new JRadioButton("Beat");
    JRadioButton r2 = new JRadioButton("Vespa");
    JRadioButton r3 = new JRadioButton("Nmax");
